  ...
  return (
    <div className="hero-bg relative ">
      ...
      <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
        ...
        <Link
          to={"/login"}
          className="text-white bg-red-600 py-1 px-2 rounded hover:bg-red-800"
        >
          Sign In
        </Link>
      </header>
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
          ...
          <button className="bg-red-600 texr-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center hover:bg-red-800">
            Get Started
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              send kids on adventures with their favorite characters in a sapce
